...
- [[#configuration][Configuration]]
  ...
  - [[#programming-modes][Programming Modes]]
    ...
    - [[#language-support][Language Support]]
      ...
      - [[#comint-enhancements][ComInt Enhancements]]
...
taiju of GitHub already wrote =ob-deno= for [[https://github.com/taiju/ob-deno][literate JS programming powered by the Deno runtime]], so I don't
have to.
...
I use =comint= features to set up a rudimentary REPL with Deno to evaluate code. Since no community
package for /this/ came up in my search, I used Mickey Petersen's excellent primer to guide the
implementation of my own barebones process.

It doesn't do anything more complex than sending code to the Deno REPL for evaluation and
exploration.
